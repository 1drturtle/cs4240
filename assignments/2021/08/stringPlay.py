...
arg = "Babbage"
p6_result_1 = arg.lower()[:10].count('b')  # same as p5?
result = 3

assert p6_result_1 == result

arg = "flibbertygibbet"
p6_result_2 = arg.lower()[:10].count('b')
result = 2
...
arg = "wabbit"
p7_result = f'{arg:!^30}'  # justify string in 30 characters useing `!` as justification character.
result = "!!!!!!!!!!!!wabbit!!!!!!!!!!!!"
...
arg = "        wabbit    "
p8_result = arg.lstrip().replace(' ', '@')  # will fail if str has space inside of it.
result = "wabbit@@@@"
